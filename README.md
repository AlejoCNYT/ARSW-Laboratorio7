...
1. Agregue al canvas de la página un manejador de eventos que permita capturar los 'clicks' realizados, bien sea a través del mouse, o a través de una pantalla táctil. Para esto, tenga en cuenta [este ejemplo de uso de los eventos de tipo 'PointerEvent'](https://mobiforge.com/design-development/html5-pointer-events-api-combining-touch-mouse-and-pen) (aún no soportado por todos los navegadores) para este fin. Recuerde que a diferencia del ejemplo anterior (donde el código JS está incrustado en la vista), se espera tener la inicialización de los manejadores de eventos correctamente modularizado, tal [como se muestra en este codepen](https://codepen.io/hcadavid/pen/BwWbrw).
   ...
   ![imagen](https://github.com/user-attachments/assets/b686b35a-26c2-4616-a315-e45911294e85)
...
![imagen](https://github.com/user-attachments/assets/7dcf5b03-e094-40d5-8c8c-706b6ed738b9)

    
	2. Se repinte el dibujo.
![imagen](https://github.com/user-attachments/assets/a1528a41-1891-4fa0-b44d-e1f7eb6082d5)
